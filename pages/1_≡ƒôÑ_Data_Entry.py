...
from utils.ui import inject_css, hero, section_head, readout_grid, status_line, pipeline_schematic, PLOTLY_TEMPLATE
...
if "last_result" in st.session_state:
    ...
    with col1:
        ...
        proba_fig.update_layout(**PLOTLY_TEMPLATE["layout"], title="Severity Class Probabilities",
    ...
    with col2:
        ...
        shap_fig.update_layout(**PLOTLY_TEMPLATE["layout"],
                                title=f"Why '{result['severity']}'? (SHAP)", height=280,
