...
from utils.ui import inject_css, hero, section_head, readout_grid, PLOTLY_TEMPLATE
...
with col1:
    ...
    fig1.update_layout(**PLOTLY_TEMPLATE["layout"], title="Severity Distribution", showlegend=False, height=320)
...
with col2:
    ...
    if len(seg_leak) > 0:
        ...
        fig2.update_layout(**PLOTLY_TEMPLATE["layout"], title="Leak Events by Segment", height=320)
...
with col3:
    ...
    fig3.update_layout(**PLOTLY_TEMPLATE["layout"], title="Water Loss Over Time (L/min)", height=320)
...
with col4:
    ...
    fig4.update_layout(**PLOTLY_TEMPLATE["layout"], title="Pressure Drop vs Flow Difference", height=320)
